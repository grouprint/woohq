...
function woohq_activate_license() {
	...
	if( isset( $_POST['woohq_license_activate'] ) ) {
		...
		$response = wp_remote_post( WOOHQ_LICENSE_URL , array( 'timeout' => 15, 'sslverify' => false, 'body' => $api_params ) );
...
function woohq_check_license() {
	...
	$response = wp_remote_post( WOOHQ_LICENSE_URL, array( 'body' => $api_params, 'timeout' => 15, 'sslverify' => false ) );
